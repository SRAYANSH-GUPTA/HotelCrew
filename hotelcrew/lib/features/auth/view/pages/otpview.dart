              ...
              child: Padding(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [const SizedBox(height: 26,),
                      Text(
                        'Verify Your Account',
                      ...
                      GestureDetector(
  // Always show the keyboard when the OTP field is tapped
  onTap: () {
  ...
  child: Focus(
    ...
    child: SizedBox(
      ...
      try {
        ...
        setState(() {
              context.loaderOverlay.hide();// Start loading
            });
        if (response != null) {
