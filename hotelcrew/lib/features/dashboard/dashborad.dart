...
class AppSetting extends ChangeNotifier {
  bool isDarkMode;
  Color themeSeed = const Color(0xFFA8C0E6);
...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<NavbarItem> items = [
      NavbarItem(Navicons.homenav, 'Home',
          backgroundColor: colors[0],
          selectedIcon: const Icon(
          Navicons.homenav,
          size: 26,
        )),
      NavbarItem(Navicons.tasknav, 'Task',
          backgroundColor: colors[1],
          selectedIcon: const Icon(
          Navicons.tasknav,
          size: 26,
        )),
      NavbarItem(Navicons.schedulenav, 'Schedule',
          backgroundColor: colors[2],
          selectedIcon: const Icon(
          Navicons.schedulenav,
          size: 26,
        )),
      NavbarItem(Icons.settings_outlined, 'Profile',
          backgroundColor: colors[0],
          selectedIcon: const Icon(
          Icons.person,
          size: 26,
